...
from backend.schemas.agent import AgentBase, AgentCreate, Agent
from sqlalchemy.orm import Session

router = APIRouter()

@router.post("/agents", tags=["auth"], response_model=Agent)
...
@router.get("/agents", tags=["auth"], response_model=list[AgentBase])
...
@router.get("/agents/{agent_id}", tags=["auth"], response_model=Agent)
